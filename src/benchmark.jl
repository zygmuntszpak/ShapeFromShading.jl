...
function benchmark_integration(integration_schemes::Array{AbstractIntegrationScheme,1}, noise_levels::AbstractArray, shape = SynthSphere(), r::Real = 50; trials::Int = 5, debug_mode = false)
    # setup ground truth
