@doc raw"""
```
img = generate_surface(shape::SynthShape, albedo::Real = 0.5, illumination_direction::Vector{T} where T <: Real = [0, 0, 1]; radius::Real, scale_factor::Real = 1.5, resolution::Real = 0.1, img_size::Real = 151)
```
...
\times\dfrac{1}{\text{resolution}}`` or `img_size` in both axes depending on the shape.
# Details
...
## `shape`
A `SynthShape` that specifies the type of shape to be generated. Available shapes
are; SynthSphere, Ripple, Ripple2, Cake, Cake2, Cup, SynthVase, Tent, Dem,
SynthGaussian and SuperGaussian.
## `albedo`
...
[0,0,1] is used.
## `radius`
A `Real` that specifies the radius of the desired shape. If left unspecified a
default value of 50 is used. Not used in all shapes.
## `scale_factor`
A `Real` that specifies the relative size of the shape in the image. If
left unspecified a default value of 1.5 is used. Not used in all shapes.
## `resolution`
A `Real` that specifies the how fine the details of the shape are. If
left unspecified a default value of 0.1 is used. Smaller numbers give higher
quality. Not used in all shapes.
## `img_size`
A `Int` that specifies the large the final image should be. Defults to 151. Used
if the image size in not dependant on the above values.
# Example
...
img = generate_surface(SynthSphere(), 0.5, [0.5,0.1,0.7], radius = 25, scale_factor = 1.25, resolution = 0.15)
```
# Reference
1. S. Elhabian, "Hands on Shape from Shading", Computer Vision and Image Processing, 2008.
"""
function generate_surface(shape::SynthSphere, albedo::Real = 0.5, illumination_direction::Vector{T} where T <: Real = [0, 0, 1]; radius::Real = 50, scale_factor::Real = 1.5, resolution::Real = 0.1, img_size::Real = 151)
    # initialize values
    ρ = albedo
...
function sythetic_gradient(shape::SynthSphere; radius::Real = 50, scale_factor::Real = 1.5, resolution::Real = 0.1, noise::Real = 0, relative_noise::Bool = false)
    r = radius
    xyrange = -scale_factor*r:resolution:scale_factor*r
    range = length(xyrange)
...
function ground_truth(shape::SynthSphere, radius::Real = 5; scale_factor::Real = 1.5, resolution::Real = 0.1)
    xyrange = -scale_factor*radius:resolution:scale_factor*radius
    range = length(xyrange)
    r = radius
...
# generate sythetic griadient map
function sythetic_gradient(shape::Ripple; radius::Real = 1, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    # initialize values
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
...
# generate sythetic griadient map
function sythetic_gradient(shape::Cake; radius::Real = 70, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function sythetic_gradient(shape::Cake2; radius::Real = 70, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function sythetic_gradient(shape::Cup; radius::Real = 70, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function sythetic_gradient(shape::SynthVase; radius::Real = 70, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function sythetic_gradient(shape::Tent; radius::Real = 70, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function sythetic_gradient(shape::Dem; radius::Real = 70, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function sythetic_gradient(shape::SynthGaussian; radius::Real = 70, img_size::Int = 151, noise::Real = 0, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function sythetic_gradient(shape::SuperGaussian; radius::Real = 70, img_size::Int = 151, noise::Real = 0, P::Real = 2, relative_noise::Bool = false)
    p = zeros(Float64, img_size, img_size)
    q = zeros(Float64, img_size, img_size)
    r = radius
    l = img_size
...
function createImage()
    ...
    on(slider1) do val
        I = [slider1[],slider2[],slider3[]]
        img = generate_surface(shape, 1, I, radius = r, img_size = imgSize)
        dis[] = img
    end
