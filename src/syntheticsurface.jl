@doc raw"""
```
img = generate_surface(shape::AbstractSyntheticShape, albedo::Real = 0.5, illumination_direction::Vector{T} where T <: Real = [0, 0, 1]; radius::Real = 50, img_size::Int=151, noise::Real = 0, relative_noise::Bool = false, background::Bool = true)
```
...
## `shape`
A `AbstractSyntheticShape` that specifies the type of shape to be generated. Available shapes
...
function generate_photometric(shape::AbstractSyntheticShape, albedo::Real = 0.5, I₁::Vector{T} where T <: Real = [0, 0, 1], I₂::Vector{T} where T <: Real = [0.5, 0, 1], I₃::Vector{T} where T <: Real = [0, 0.5, 1]; radius::Real = 50, img_size::Int=151, noise::Real = 0, relative_noise::Bool = false, background::Bool = true)
...
function ground_truth(shape::AbstractSyntheticShape; radius::Real = 50, img_size::Int=151)
