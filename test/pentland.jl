@testset "pentland" begin
    ...
    @test isapprox(Z[1,1], 1.6063661929819305e-14; atol = 2e-15)
    @test isapprox(Z[151,151], 1.1842354207459187e-14; atol = 2e-15)
    @test Z[90,90] ≈ 7.596179360050504
    @test Z[101,36] ≈ 3.0163090221571354
    @test isapprox(Z[22, 136], 1.468693863573891e-14; atol = 2e-15)
